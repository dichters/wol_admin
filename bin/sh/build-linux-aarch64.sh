#!/bin/bash
# Build & package wol-panel for Linux aarch64
# 用法：./bin/sh/build-linux-aarch64.sh [version]
set -euo pipefail
cd "$(dirname "$0")/../.."
...
echo "Building wol-panel v${VERSION} linux/arm64"
...
PKG_NAME="wol-panel-${VERSION}-linux-aarch64"
